 ...
 * MapReduce program
 */
public class DriverBigData extends Configured implements Tool { // TODO: understand why the second job returns 2 immediately, before printing anything
	...
	public int run(String[] args) throws Exception {
		...
		*/
		...
		if (job.waitForCompletion(true)) {
			...
			Path outputDir2;
			int numberOfReducersJob2 = 1;  // needed for Top K pattern
